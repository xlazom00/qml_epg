...
Item {
    ...
    property color defaultBackgroundColor: Qt.darker("#00"+unity2dConfiguration.averageBgColor.substring(unity2dConfiguration.averageBgColor.lastIndexOf("#")+1), 3)
    property color selectedBackgroundColor: "#88dddddd"
